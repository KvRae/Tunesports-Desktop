...
public Mise_a_jour(int idJ, int idmise, String nomj, Date pubmise, String versionmise, int taillemise,
		String descmise) {
}
...
public Date getPubmise() {
	return pubmise;
}



public void setPubmise(Date pubmise) {
	this.pubmise = pubmise;
}



public String getVersionmise() {
	return versionmise;
}
...
public String getDescmise() {
	return descmise;
}



public void setDescmise(String descmise) {
	this.descmise = descmise;
}
...
public String toString() {
	return "Mise_a_jour [idmise=" + idmise + ", nomjeu=" + nomjeu + ", pubmise=" + pubmise + ", versionmise="
			+ versionmise + ", taillemise=" + taillemise + ", descmise=" + descmise + ", idjeux=" + idjeux +"]";
}

//@Override
//public String toString() {
	//return "Mise_a_jour [nomjeux=" + nomjeux + ", pubmise=" + pubmise + ", versionmise="
			//+ versionmise + ", taillemise=" + taillemise + ", descmise=" + descmise + ", idjeux=" + idjeux +"]";
//}
