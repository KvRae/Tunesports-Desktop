...
public class Commentaires {
  ...
  public Commentaires(int idcommentaire, String titrecommentaire,
                      String contenucommentaire, Date datecommentaire,
                      int idArt) {
  ...
  public Commentaires(String titrecommentaire, String contenucommentaire,
                      int idArt) {
    this.titrecommentaire = titrecommentaire;
    this.contenucommentaire = contenucommentaire;
    this.idArt = idArt;
  ...
  public String getTitrecommentaire() { return titrecommentaire; }

  public void setTitrecommentaire(String titrecommentaire) {
    this.titrecommentaire = titrecommentaire;
  }

  public String getContenucommentaire() { return contenucommentaire; }
  ...
  public String toString() {
    return "Commentaires{"
        ...
        ", datecommentaire=" + datecommentaire + ", idArt=" + idArt + '}';
  }
}
