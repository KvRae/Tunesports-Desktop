...
public class Article {
    ...
    public String toString() {
        return "Article{" + "IdArticle=" + IdArticle + ", TitreArticle=" + TitreArticle + ", DescriptionArticle=" + DescriptionArticle + ", DateArticle=" + DateArticle + ", ImageArticle=" + ImageArticle + ", idArticle=" + idArticle + ", user_id=" + user_id + '}';
    }
