...
public class AjoutereventController implements Initializable {
    ...
    @FXML
    private DatePicker txtdatedebevent;
    @FXML
    private DatePicker txtdatefinevent;
    @FXML
    private TextField txtdescevent;
    @FXML
    private Button btn;
    @FXML
    private Button btn2;  
    ...
    @FXML
    private Button btnrechev;
    @FXML
    private RadioButton rdnomev;
    @FXML
    private RadioButton rddateev;
    @FXML
    private RadioButton rdidev;
    @FXML
    private RadioButton tri_asc;
    @FXML
    private RadioButton tri_desc;
    @FXML
    private ToggleGroup tri_descendant;
    @FXML
    private RadioButton dateplev;
    @FXML
    private RadioButton dateanev;
    @FXML
    private Button pdfev;
    @FXML
    private ListView listview=new ListView() ;
    @FXML
    private AnchorPane Ajouterevent;
    EvenementService se=new EvenementService();
 
    private final ObservableList<Evenement> EvenementList = FXCollections.observableArrayList(se.afficher());
    private final ObservableList<Evenement> tra = FXCollections.observableArrayList(se.trie());
    private final ObservableList<Evenement> trad = FXCollections.observableArrayList(se.triedesc());
    private final ObservableList<Evenement> tradd = FXCollections.observableArrayList(se.tried());
    private final ObservableList<Evenement> tradf = FXCollections.observableArrayList(se.triedescd());
    private final ObservableList<Evenement> histo = FXCollections.observableArrayList(se.historique());
    ...
    @FXML
    private void pdfevent(ActionEvent event) throws FileNotFoundException, DocumentException {   
    ...
    private void getclickeditem(MouseEvent event) {
        Evenement selecteditem=(Evenement) listview.getSelectionModel().getSelectedItem();
