...
public class AjoutertourController implements Initializable {
  ...
  @FXML private AnchorPane Ajoutertour;
  @FXML private DatePicker txtdatedebt;
  @FXML private DatePicker txtdatefint;
  @FXML private Button btn;
  @FXML private Button btn1;
  @FXML private Button btn2;
  @FXML private Button btnm;
  @FXML private TextField txtidt;
  @FXML private TextField txtnomt;
  @FXML private TextField txtdesct;
  @FXML private TextField txtrecomt;
  @FXML private ListView listviewt = new ListView();
  TournoiService ts = new TournoiService();
  private final ObservableList<Tournoi> tournoilist =
      FXCollections.observableArrayList(ts.afficher());
  private final ObservableList<Tournoi> tourt =
      FXCollections.observableArrayList(ts.trie());
  private final ObservableList<Tournoi> tourdest =
      FXCollections.observableArrayList(ts.tried());
  private final ObservableList<Tournoi> tourdesct =
      FXCollections.observableArrayList(ts.triedesc());
  private final ObservableList<Tournoi> tourdescdt =
      FXCollections.observableArrayList(ts.triedescd());
  private final ObservableList<Tournoi> histot =
      FXCollections.observableArrayList(ts.historique());

  private int selectedindex = -1;
  @FXML private Button pdft;
  @FXML private RadioButton tri_asc;
  @FXML private ToggleGroup tris;
  @FXML private RadioButton tri_desc;
  @FXML private RadioButton dateplt;
  @FXML private RadioButton tri_nom;
  @FXML private Button btnrecht;
  @FXML private RadioButton rdidt;
  @FXML private ToggleGroup rech;
  @FXML private RadioButton rdnomt;
  @FXML private RadioButton rddatet;
  @FXML private Button histort;
  @FXML private Button btnqt;
  @FXML private TextField txtrecht;
  private MaConnexion cnx;
  @FXML private Button barcodet;
  /**
  ...
  private void getclickeditemt(MouseEvent event) {
    Tournoi selecteditem =
        (Tournoi)listviewt.getSelectionModel().getSelectedItem();
  ...
  @FXML
  private void pdftou(ActionEvent event)
